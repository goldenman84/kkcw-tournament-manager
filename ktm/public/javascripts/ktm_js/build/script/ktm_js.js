...
var envinfo = {"qx.application":"ktm_js.Application","qx.debug":false,"qx.debug.databinding":false,"qx.debug.dispose":false,"qx.optimization.basecalls":true,"qx.optimization.comments":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.variants":true,"qx.revision":"","qx.theme":"ktm_js.theme.Theme","qx.version":"1.6"};
for (var k in envinfo) qx.$$environment[k] = envinfo[k];

if (!qx.$$libraries) qx.$$libraries = {};
var libinfo = {"__out__":{"sourceUri":"script"},"ktm_js":{"resourceUri":"resource","sourceUri":"script"},"qx":{"resourceUri":"resource","sourceUri":"script"}};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:ktm_js.6f8bcacf2ec2.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="os.name",b="engine.version",a="ktm_js.Application";
...
(function(){var g="execute",f="ktm_js/test.png",d="isle",c="First Button",b="ktm_js.Application",a="absolutely positioned";
...
var i=new qx.ui.root.Inline(n,true,true);
i.setLayout(new qx.ui.layout.VBox);
var h=new qx.ui.container.Composite(new qx.ui.layout.HBox);
var m=new qx.ui.form.Button(c,f);
m.setAllowStretchY(false);
h.add(m);
h.setPadding(10);
var k=new qx.ui.core.Spacer();
h.add(k,{flex:1});
var j=new qx.ui.control.DateChooser;
h.add(j);
i.add(h);
m.addListener(g,function(e){alert("I'm a button inside an inline root widget!\n"+"I nicely fit into the page layout flow.");
});
var l=new qx.ui.form.Button(a);
this.getRoot().add(l,{left:500,top:310});
l.addListener(g,function(e){alert("I'm an absolutely positioned button!\n"+"I overlay existing content.");
});
}}});
})();
...
}},properties:{alignY:{check:[m,j,e],init:m,apply:n},alignX:{check:[k,g,a],init:k,apply:n},spacing:{check:c,init:0,apply:n},separator:{check:h,nullable:true,apply:n},reversed:{check:b,init:false,apply:f}},members:{__kM:null,__kN:null,__kO:null,__ff:null,_applyReversed:function(){this._invalidChildrenCache=true;
this._applyLayoutChange();
},__kP:function(){var w=this._getLayoutChildren();
var length=w.length;
var s=false;
var r=this.__kM&&this.__kM.length!=length&&this.__kN&&this.__kM;
var u;
var t=r?this.__kM:new Array(length);
var v=r?this.__kN:new Array(length);
...
},verifyLayoutProperty:null,renderLayout:function(x,y){if(this._invalidChildrenCache){this.__kP();
}var F=this.__ff;
var length=F.length;
...
for(i=0;i<length;i+=1){J=this.__kM[i];
B=J!=null?Math.floor((y-C)*J):F[i].getSizeHint().height;
K.push(B);
Q+=B;
}if(this.__kO&&Q!=y){var H={};
var N,R;

for(i=0;i<length;i+=1){N=this.__kN[i];
...
}},destruct:function(){this.__kM=this.__kN=this.__ff=null;
}});
})();
...
if(q){this.setSeparator(q);
}},properties:{alignX:{check:[m,k,c],init:m,apply:n},alignY:{check:[j,g,e],init:j,apply:n},spacing:{check:a,init:0,apply:n},separator:{check:h,nullable:true,apply:n},reversed:{check:d,init:false,apply:f}},members:{__kQ:null,__kN:null,__kO:null,__ff:null,_applyReversed:function(){this._invalidChildrenCache=true;
this._applyLayoutChange();
},__kP:function(){var w=this._getLayoutChildren();
var length=w.length;
var t=false;
var r=this.__kQ&&this.__kQ.length!=length&&this.__kN&&this.__kQ;
var u;
var s=r?this.__kQ:new Array(length);
var v=r?this.__kN:new Array(length);
if(this.getReversed()){w=w.concat().reverse();
}for(var i=0;i<length;i++){u=w[i].getLayoutProperties();
...
for(i=0;i<length;i+=1){J=this.__kQ[i];
K=J!=null?Math.floor((x-B)*J):E[i].getSizeHint().width;
P.push(K);
F+=K;
}if(this.__kO&&F!=x){var H={};
var L,O;

for(i=0;i<length;i+=1){L=this.__kN[i];
...
}},destruct:function(){this.__kQ=this.__kN=this.__ff=null;
}});
})();
(function(){var n="execute",m="toolTipText",l="icon",k="label",j="qx.ui.core.MExecutable",h="value",g="qx.event.type.Event",f="_applyCommand",d="enabled",c="menu",a="changeCommand",b="qx.ui.core.Command";
qx.Mixin.define(j,{events:{"execute":g},properties:{command:{check:b,apply:f,event:a,nullable:true}},members:{__kR:null,__kS:false,__kT:null,_bindableProperties:[d,k,l,m,h,c],execute:function(){var o=this.getCommand();

if(o){if(this.__kS){this.__kS=false;
}else{this.__kS=true;
o.execute(this);
}}this.fireEvent(n);
},__kU:function(e){if(this.__kS){this.__kS=false;
return;
}this.__kS=true;
this.execute();
},_applyCommand:function(p,q){if(q!=null){q.removeListenerById(this.__kT);
}
if(p!=null){this.__kT=p.addListener(n,this.__kU,this);
}var t=this.__kR;

if(t==null){this.__kR=t={};
}var u;
...
qx.Class.define(l,{statics:{__kV:qx.locale.Manager.getInstance(),getAmMarker:function(F){return this.__kV.localize(o,[],F);
},getPmMarker:function(G){return this.__kV.localize(p,[],G);
},getDayNames:function(length,H,I,J){var I=I?I:h;
var L=[B,C,D,a,e,E,d];
var M=[];

for(var i=0;i<L.length;i++){var K=c+I+k+length+k+L[i];
M.push(J?this.__kW(I,I===j?f:j,K,H):this.__kV.localize(K,[],H));
}return M;
},getDayName:function(length,N,O,P,Q){var P=P?P:h;
var S=[B,C,D,a,e,E,d];
var R=c+P+k+length+k+S[N];
return Q?this.__kW(P,P===j?f:j,R,O):this.__kV.localize(R,[],O);
},getMonthNames:function(length,T,U,V){var U=U?U:h;
var X=[];

for(var i=0;i<12;i++){var W=b+U+k+length+k+(i+1);
X.push(V?this.__kW(U,U===j?f:j,W,T):this.__kV.localize(W,[],T));
}return X;
},getMonthName:function(length,Y,ba,bb,bc){var bb=bb?bb:h;
var bd=b+bb+k+length+k+(Y+1);
return bc?this.__kW(bb,bb===j?f:j,bd,ba):this.__kV.localize(bd,[],ba);
},getDateFormat:function(be,bf){var bg=v+be;
return this.__kV.localize(bg,[],bf);
},getDateTimeFormat:function(bh,bi,bj){var bl=m+bh;
var bk=this.__kV.localize(bl,[],bj);

if(bk==bl){bk=bi;
}return bk;
},getTimeFormat:function(bm,bn){var bp=t+bm;
var bo=this.__kV.localize(bp,[],bn);
...
}else{bE=this.__kV.getTerritory()||this.__kV.getLanguage();
}return bE.toUpperCase();
},__kW:function(bF,bG,bH,bI){var bK=this.__kV.localize(bH,[],bI);

if(bK==bH){var bJ=bH.replace(g+bF+g,g+bG+g);
return this.__kV.localize(bJ,[],bI);
}else{return bK;
}}}});
})();
...
qx.Mixin.define(d,{construct:function(){if(qx.core.Environment.get(l)){qx.locale.Manager.getInstance().addListener(j,this.__kX,this);
...
},__kX:qx.core.Environment.select(l,{"true":function(e){var o=this.getInvalidMessage();
...
}},"false":null})},destruct:function(){if(qx.core.Environment.get(l)){qx.locale.Manager.getInstance().removeListener(j,this.__kX,this);
}}});
})();
...
for(var i=0;i<6*7;i++){var bu=this.__la[i];
...
for(var bK=0;bK<6;bK++){this.__lb[bK].setValue(cg.format(cc));

for(var i=0;i<7;i++){var ch=this.__la[bK*7+i];
...
}this.__kY=this.__la=this.__lb=null;
}});
})();
...
}},properties:{spacingX:{check:h,init:0,apply:p},spacingY:{check:h,init:0,apply:p}},members:{__le:null,__lc:null,__ld:null,__lf:null,__lg:null,__lh:null,__li:null,__lj:null,__lk:null,verifyLayoutProperty:null,__ll:function(){var B=[];
var A=[];
var C=[];
var w=-1;
var v=-1;
...
this.__lk=null;
delete this._invalidChildrenCache;
},_setRowData:function(G,H,I){var J=this.__lc[G];

if(!J){this.__lc[G]={};
this.__lc[G][H]=I;
}else{J[H]=I;
}},_setColumnData:function(K,L,M){var N=this.__ld[K];
...
this._applyLayoutChange();
return this;
},getColumnAlign:function(S){var T=this.__ld[S]||{};
return {vAlign:T.vAlign||q,hAlign:T.hAlign||r};
},setRowAlign:function(U,V,W){this._setRowData(U,o,V);
this._setRowData(U,m,W);
this._applyLayoutChange();
return this;
},getRowAlign:function(X){var Y=this.__lc[X]||{};
return {vAlign:Y.vAlign||q,hAlign:Y.hAlign||r};
},getCellWidget:function(ba,bb){if(this._invalidChildrenCache){this.__ll();
}var ba=this.__le[ba]||{};
return ba[bb]||null;
},getRowCount:function(){if(this._invalidChildrenCache){this.__ll();
}return this.__lh+1;
},getColumnCount:function(){if(this._invalidChildrenCache){this.__ll();
}return this.__li+1;
},getCellAlign:function(bc,bd){var bj=q;
var bh=r;
var bi=this.__lc[bc];
var bf=this.__ld[bd];
var be=this.__le[bc][bd];
...
for(var i=0,l=this.__lg.length;i<l;i++){var cl=this.__lg[i];
var ch=this.__lm(cl);
...
for(var i=0,l=this.__lf.length;i<l;i++){var ct=this.__lf[i];
var cv=this.__lm(ct);
...
for(var j=0;j<cy.colSpan;j++){cB=cA[cu+j]?cA[cu+j].offset:0;
cs[cu+j].minWidth+=cB;
}}}},_getRowHeights:function(){if(this.__lj!=null){return this.__lj;
}var cP=[];
var cI=this.__lh;
var cH=this.__li;
...
for(var cO=0;cO<=cH;cO++){var cG=this.__le[cQ][cO];
...
if(this.__lg.length>0){this._fixHeightsRowSpan(cP);
}this.__lj=cP;
return cP;
},_getColWidths:function(){if(this.__lk!=null){return this.__lk;
}var cV=[];
var cS=this.__li;
var cU=this.__lh;
...
for(var dc=0;dc<=cU;dc++){var cR=this.__le[dc][db];
...
if(this.__lf.length>0){this._fixWidthsColSpan(cV);
}this.__lk=cV;
return cV;
...
},renderLayout:function(ds,dt){if(this._invalidChildrenCache){this.__ll();
...
for(var dC=0;dC<=du;dC++){var dJ=this.__le[dC][dP];
if(!dJ){top+=dV[dC]+dB;
continue;
...
return eb;
}},destruct:function(){this.__le=this.__lc=this.__ld=this.__lf=this.__lg=this.__lk=this.__lj=null;
}});
})();
...
this.__ln=qx.locale.Manager.getInstance().bind(dn,this,dn);
}else{this.__iz=dt;
this.setLocale(dt);
}this.__lo=this.__iz;

if(ds!=null){this.__lp=ds.toString();

if(this.__lp in qx.util.format.DateFormat.ISO_MASKS){if(this.__lp===d){this.__lq=true;
}this.__lp=qx.util.format.DateFormat.ISO_MASKS[this.__lp];
}}else{this.__lp=qx.locale.Date.getDateFormat(bd,this.__iz)+N+qx.locale.Date.getDateTimeFormat(dq,dl,this.__iz);
...
if(dv._dateInstance==null||dv._dateInstance.__lp!=du){dv._dateTimeInstance=new dv();
...
if(dx._dateInstance==null||dx._dateInstance.__lp!=dw){dx._dateInstance=new dx(dw);
}return dx._dateInstance;
},ASSUME_YEAR_2000_THRESHOLD:30,LOGGING_DATE_TIME__format:da,ISO_MASKS:{isoDate:"yyyy-MM-dd",isoTime:"HH:mm:ss",isoDateTime:"yyyy-MM-dd'T'HH:mm:ss",isoUtcDateTime:"yyyy-MM-dd'T'HH:mm:ss'Z'"},AM_MARKER:"am",PM_MARKER:"pm"},members:{__ln:null,__iz:null,__lo:null,__lp:null,__lr:null,__ls:null,__lt:null,__lq:null,__lu:function(dy,dz){var dA=cG+(dy<0?((-1)*dy):dy);

while(dA.length<dz){dA=bH+dA;
}return dy<0?cF+dA:dA;
},__lv:function(dB){var dC=new Date(dB.getTime());
var dD=dC.getDate();

while(dC.getMonth()!=0){dC.setDate(-1);
dD+=dC.getDate()+1;
}return dD;
},__lw:function(dE){return new Date(dE.getTime()+(3-((dE.getDay()+6)%7))*86400000);
},__lx:function(dF){var dH=this.__lw(dF);
var dI=dH.getFullYear();
var dG=this.__lw(new Date(dI,0,4));
return Math.floor(1.5+(dH.getTime()-dG.getTime())/86400000/7);
},__ly:function(dJ){var dL=this.__lw(dJ);
var dK=this.__lw(new Date(dJ.getFullYear(),dJ.getMonth(),4));
return Math.floor(1.5+(dL.getTime()-dK.getTime())/86400000/7);
},__lz:function(dM){var dN=this.__lw(dM);
return dN.getFullYear();
},__lA:function(dO){var dP=new Date(dO,2,1);
dP.setDate(-1);
return dP.getDate()+1===29;
},__lB:function(dQ,dR){var dV=0;
var dW=0;
if(!dR){dR=1971;
}var dS=0;
...
},__lC:function(dX,dY,ea){var eb;

switch(dY){case 11:eb=dX-1;

if(dX!=this.__lz(new Date(eb,dY,ea))){eb=dX;
}break;
case 0:eb=dX+1;
...
},_applyLocale:function(ec,ed){this.__iz=ec===null?this.setLocale(this.__lo):ec;
},format:function(ee){if(ee==null){return null;
}
if(isNaN(ee.getTime())){return null;
}
if(this.__lq){ee=new Date(ee.getUTCFullYear(),ee.getUTCMonth(),ee.getUTCDate(),ee.getUTCHours(),ee.getUTCMinutes(),ee.getUTCSeconds(),ee.getUTCMilliseconds());
}var eh=this.__iz;
...
for(var i=0;i<this.__lt.length;i++){var en=this.__lt[i];
...
switch(eg){case x:if(er==2){ez=this.__lu(em%100,2);
...
case cl:if(er==1||er==2){ez=this.__lu(parseInt(ei/4)+1,er);
}
if(er==3){ez=cl+(parseInt(ei/4)+1);
}break;
case U:if(er==1||er==2){ez=this.__lu(parseInt(ei/4)+1,er);
}
if(er==3){ez=cl+(parseInt(ei/4)+1);
}break;
case cz:ez=this.__lu(this.__lv(ee),er);
break;
case dc:ez=this.__lu(el,er);
break;
case A:ez=this.__lu(this.__lx(ee),er);
break;
case E:ez=this.__ly(ee);
break;
...
if(er>=1&&er<=2){ez=this.__lu(eu,er);
...
case H:if(er==1||er==2){ez=this.__lu(ei+1,er);
...
case t:if(er==1||er==2){ez=this.__lu(ei+1,er);
...
break;
case ca:ez=this.__lu(es,er);
break;
case cu:ez=this.__lu((es==0)?24:es,er);
break;
case cy:ez=this.__lu(es%12,er);
break;
case bT:ez=this.__lu(((es%12)==0)?12:(es%12),er);
break;
case m:ez=this.__lu(ey,er);
break;
case bR:ez=this.__lu(eq,er);
break;
case cb:ez=ew+cG;
...
case bb:if(er>=1&&er<=4){ez=dm+((et>0)?cF:cO)+this.__lu(Math.abs(ef),2)+w+this.__lu(ev,2);
}break;
case K:if(er>=1&&er<=3){ez=((et>0)?cF:cO)+this.__lu(Math.abs(ef),2)+this.__lu(ev,2);
}else{ez=dm+((et>0)?cF:cO)+this.__lu(Math.abs(ef),2)+w+this.__lu(ev,2);
}break;
}ex+=ez;
}}return ex;
},parse:function(eA){this.__lE();
var eJ=this.__lr.regex.exec(eA);

if(eJ==null){throw new Error("Date string '"+eA+"' does not match the date format: "+this.__lp);
...
for(var i=0;i<this.__lr.usedRules.length;i++){var eF=this.__lr.usedRules[i];
var eG=eJ[eD];
...
for(var k=0;k<this.__lr.usedRules.length;k++){if(this.__lr.usedRules[k].pattern==dr){eH=true;
break;
}}
if(!eH){eC=true;
}}
...
for(var k=0;k<this.__lr.usedRules.length;k++){if(this.__lr.usedRules[k].pattern.indexOf(bi)!=-1){eL=true;
break;
}}
if(!eL){eE=true;
}}eD+=(eF.groups==null)?1:eF.groups;
}
if(eC){eB.year=this.__lC(eB.weekYear,eB.month,eB.day);
}
if(eE){var eK=this.__lB(eB.dayOfYear,eB.year);
eB.month=eK.month;
eB.day=eK.day;
}
...
if(this.__lq){eI=new Date(eI.getUTCFullYear(),eI.getUTCMonth(),eI.getUTCDate(),eI.getUTCHours(),eI.getUTCMinutes(),eI.getUTCSeconds(),eI.getUTCMilliseconds());
}
...
},__lD:function(){if(this.__lt!=null){return;
}this.__lt=[];
var eQ;
var eO=0;
var eS=cG;
...
case bF:if(eR==eQ){eO++;
i++;
}else{this.__lt.push({type:bF,character:eQ,size:eO});
eQ=null;
eO=0;
eP=bI;
}break;
...
if(eP!=bI){if(eS.length>0){this.__lt.push({type:bG,text:eS});
eS=cG;
}}else{eS+=eR;
i++;
}break;
}}if(eQ!=null){this.__lt.push({type:bF,character:eQ,size:eO});
}else if(eS.length>0){this.__lt.push({type:bG,text:eS});
}},__lE:function(){if(this.__lr!=null){return ;
}var eW=this.__lp;
this.__lG();
this.__lD();
var fd=[];
...
for(var eU=0;eU<this.__lt.length;eU++){var fe=this.__lt[eU];
...
for(var ff=0;ff<this.__ls.length;ff++){var fb=this.__ls[ff];

if(this.__lF(fb,eV,fa)){eX=fb;
break;
...
}this.__lr={regex:eT,"usedRules":fd,pattern:eY};
},__lF:function(fh,fi,fj){if(fi===x&&fh.pattern===dr){fh.regex=fh.regexFunc(fj);
return true;
}else if(fi===be&&fh.pattern===bw){fh.regex=fh.regexFunc(fj);
return true;
}else{return fi==fh.pattern.charAt(0)&&fj==fh.pattern.length;
}},__lG:function(){var fx=qx.util.format.DateFormat;
...
}},destruct:function(){if(this.__ln!=null){qx.locale.Manager.getInstance().removeBinding(this.__ln);
}this.__lt=this.__lr=this.__ls=null;
}});
})();
...
},getMarkup:function(e){if(this.__lH){return this.__lH;
...
}},properties:{innerColor:{check:d,nullable:true,apply:i},innerOpacity:{check:o,init:1,apply:i},outerColor:{check:d,nullable:true,apply:i}},members:{__lH:null,_getDefaultInsets:function(){return {top:2,right:2,bottom:2,left:2};
},_isInitialized:function(){return !!this.__lH;
},_applyStyle:function(){},getMarkup:function(){if(this.__lH){return this.__lH;
...
if(qx.ui.decoration.css3.BorderImage.IS_SUPPORTED){this.__lI=new qx.ui.decoration.css3.BorderImage();

if(p){this.__lJ(p);
}}else{this.__lI=new qx.ui.decoration.GridDiv(p);
}
if(q!=null){this.__lI.setInsets(q);
}},properties:{baseImage:{check:d,nullable:true,apply:j},insetLeft:{check:o,nullable:true,apply:n},insetRight:{check:o,nullable:true,apply:n},insetBottom:{check:o,nullable:true,apply:n},insetTop:{check:o,nullable:true,apply:n},insets:{group:[k,l,i,e],mode:f}},members:{__lI:null,getMarkup:function(){return this.__lI.getMarkup();
},resize:function(r,s,t){this.__lI.resize(r,s,t);
},tint:function(u,v){},getInsets:function(){return this.__lI.getInsets();
},_applyInsets:function(w,x,name){var y=g+qx.lang.String.firstUp(name);
this.__lI[y](w);
},_applyBaseImage:function(z,A){if(this.__lI instanceof qx.ui.decoration.GridDiv){this.__lI.setBaseImage(z);
}else{this.__lJ(z);
}},__lJ:function(B){var G,H,J,I;
this.__lI.setBorderImage(B);
...
this.__lI.setSlice([N,D,E,O]);
}},destruct:function(){this.__lI.dispose();
this.__lI=null;
}});
})();
...
}},statics:{IS_SUPPORTED:qx.bom.element.Style.isPropertySupported("borderImage")},properties:{borderImage:{check:t,nullable:true,apply:j},sliceTop:{check:h,init:0,apply:j},sliceRight:{check:h,init:0,apply:j},sliceBottom:{check:h,init:0,apply:j},sliceLeft:{check:h,init:0,apply:j},slice:{group:[n,v,a,w],mode:c},repeatX:{check:[i,e,d],init:i,apply:j},repeatY:{check:[i,e,d],init:i,apply:j},repeat:{group:[u,m],mode:c}},members:{__lH:null,_getDefaultInsets:function(){return {top:0,right:0,bottom:0,left:0};
},_isInitialized:function(){return !!this.__lH;
...
this.__lH=[x,qx.bom.element.Style.compile({"borderImage":o+B+p+C.join(f)+f+D,position:k,lineHeight:0,fontSize:0,overflow:l,boxSizing:r,borderWidth:C.join(b)+g}),y].join(q);
return this.__lH;
...
}},__lM:function(K){var O=this._generateBackgroundMarkup(K);
...
K[y]=0;
K[p]=0;
return this.__lK=this._generateBackgroundMarkup(K,O);
},__lN:function(S,T,U){var V=this.getInsets();
T-=V.left+V.right;
U-=V.top+V.bottom;
...
},__lO:function(){return {top:this.getWidthTop()+this.getInnerWidthTop(),right:this.getWidthRight()+this.getInnerWidthRight(),bottom:this.getWidthBottom()+this.getInnerWidthBottom(),left:this.getWidthLeft()+this.getInnerWidthLeft()};
}}});
})();
...
(function(){var a="ktm_js.theme.Decoration";
...
(function(){var a="ktm_js.theme.Appearance";
...
(function(){var a="ktm_js.theme.Font";
...
(function(){var a="ktm_js.theme.Color";
qx.Theme.define(a,{extend:qx.theme.modern.Color,colors:{}});
})();
(function(){var a="ktm_js.theme.Theme";
qx.Theme.define(a,{meta:{color:ktm_js.theme.Color,decoration:ktm_js.theme.Decoration,font:ktm_js.theme.Font,icon:qx.theme.icon.Tango,appearance:ktm_js.theme.Appearance}});
})();
