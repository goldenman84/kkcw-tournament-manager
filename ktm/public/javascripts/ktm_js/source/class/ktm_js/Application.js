...
/**
 * This is the main application class of your custom application "ktm_js"
 */
qx.Class.define("ktm_js.Application",
{
  ...
  members :
  {
    ...
    main : function()
    {
      ...
      */
      ...
      // Create a button
      var button1 = new qx.ui.form.Button("First Button", "ktm_js/test.png");
